              ...
              <div className="bg-zinc-900/80 border border-zinc-800 p-4 rounded-xl space-y-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Type title (e.g. Parasite, Breaking Bad, Death Note) or paste link"
                      ...
                      {lbSuggestions.map((movie, index) => (
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="text-[10px] text-zinc-500 font-mono mt-0.5 truncate">Creator/Dir: {movie.director || 'Unknown'} • {movie.genre || 'Cinema'}</div>
                          </div>
                        </button>
                      ))}
                    </div>
